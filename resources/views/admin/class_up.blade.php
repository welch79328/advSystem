                        ...
                        <div class="box-content">
                            ...
                            <form action="{{url('admin/class_deal_with')}}" method="post" enctype="multipart/form-data" id="form1" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="s_name" type="text" class="form-control" id="s_name" placeholder="廣告類型名稱 (Ad Type Name)" value="{{$style->s_name}}">
                                </div>
                                <div class="form-group">
                                    <label for="s_type">廣告類型代碼 (Ad Type Code)</label>
                                    <input name="s_type" type="text" class="form-control" id="s_type" placeholder="廣告類型代碼 (Ad Type Code)" value="{{$style->s_type}}">
                                </div>
                                <div class="form-group">
                                    <label for="s_filename">樣式檔CSS上傳 (Style files CSS Upload)</label>
                                    <a class="note" href="{{asset($style->s_filename)}}">目前檔案:{{$style['s_file_name'][2]}}</a>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="s_status" id="s_status1" value="1" @if($style->s_status == 1) checked="CHECKED" @endif> 上架 (Start)
                                    <input name="s_status" type="radio" id="s_status2" value="0" @if($style->s_status == 0) checked="CHECKED" @endif> 下架 (Stop)
                                </div>
                                ...
                                <input name="s_id" type="hidden" id="s_id" value="{{$style->s_id}}">
                                <input name="s_filename2" type="hidden" id="s_id" value="{{$style->s_filename}}">
                            </form>
